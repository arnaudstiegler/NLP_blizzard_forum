...
if __name__ == '__main__':
	...
	url_list, thread_name_list = retrieve_thread_url(number_thread = 10000)
	data = scrape_thread_multiprocessing(url_list,num_process=2)

	json_dump('data/10000_posts.json', data, thread_name_list, url_list)
